...
const skillCategories = {
	web: {
		...
		icon: CodepenIcon,
		description: "Building scalable and data-driven web applications",
		languages: [
			"HTML",
			"CSS",
			"JavaScript",
	...
	api: {
		...
		icon: WebhookIcon,
		description: "Designing RESTful APIs and distributed backend systems",
		languages: [
			"PHP",
			"Laravel",
			"Python",
	...
	ai: {
		...
		icon: ActivityIcon,
		description: "Applying machine learning for data analysis and prediction",
		languages: [
			"Python",
			"Scikit-learn",
			"Pandas",
	...
	infrastructure: {
		...
		icon: ActivityIcon,
		description: "Managing servers, virtualization, networking, and system environments",
		languages: [],
		tools: [
			"Linux (Ubuntu / Debian)",
